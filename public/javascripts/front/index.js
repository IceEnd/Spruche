                ...
                if(data.type){
                    ...
                    for(var b in blogs){
                        htmlStr += '<li class="article-li"><article><div class="article-info-div"><div class="article-user-img-div float-left"><img src="'+
                            ...
                            '</h3> <div class="article-other-info"><span><a class="article-author">'+blogs[b].username+'</a></span><span><a class="article-comments-num" href="https://localhost/article/av>'+
                            blogs[b].id+'#disqus_thread">0 Comment</a></span><span><a class="article-view-num">'+blogs[b].view_num+'</a></span><span><a class="article-date">'+
